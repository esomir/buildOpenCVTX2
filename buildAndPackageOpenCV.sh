...
# Fix libGL references
if [ -f /usr/lib/aarch64-linux-gnu/mesa/libGL.so ]; then
  sudo ln -s /usr/lib/aarch64-linux-gnu/mesa/libGL.so /usr/lib/aarch64-linux-gnu/libGL.so
fi
